...
//----------------------------------------------USER-------------------------------------------------------------
 ...
 //----------------------------------------------SERIE USER-------------------------------------------------------------
    ...
    public SerieUser getSerieUserInlist(@PathVariable String email, @PathVariable Long id, @RequestParam int season) {
        User existingUser = userService.getUserById(email);
        if (existingUser != null) {
...
//----------------------------------------------AGREGAR SERIE----------------------------------------------------
    ...
    public List<SerieUser> addSerie(@PathVariable String email, @RequestParam Long id){
